...
function getData(toPage=1){
    ...
    .then(function (response) {
        ...
        (response.data.products).forEach((item) => {
            console.log(item.tittle); // Tambahkan logging untuk memastikan title tidak undefined atau null
            template += `   <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="single-product-item text-center">
                                    <div class="products-images">
                                        <a href="/book/`+item.id+`" class="product-thumbnail">
                                            <img src="`+item.cover+`" alt="Product Images" height="200" style="border:4px solid #FFCBCB; border-radius:10px">
                                        </a>
                                    ...
                                    <div class="product-content">
                                        <h6 class="product-title">
                                            <a href="/figure/`+item.id+`">`+item.tittle+`</a>
                                        </h6>
