    ...
    public function index(Request $request)
    {
        try {
            ...
            if($request->get('_search')){
                $data['products'] = $data['products']->whereRaw('(LOWER(tittle) LIKE "%'.strtolower($request->get('_search')).'%")');
            }
            ...
            switch ($request->get('_sort_by')) {
                ...
                break;
                case 'title_asc':
                $data['products'] = $data['products']->orderBy('tittle','ASC');
                break;
                case 'title_desc':
                $data['products'] = $data['products']->orderBy('tittle','DESC');
                break;
                case 'price_asc':
