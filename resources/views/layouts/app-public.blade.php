...
<html lang="{{str_replace('_', '-', app()->getLocale())}}">
    <head>
        ...
        <meta name="author" content="422023013 - Nayla larasati">

        <title>@yield('tittle') | 422023013 - Nayla larasati</title>
        <link rel="icon" type="image/x-icon" href="{{asset('assets/images/icons/LOGO2123')}}">
        <!-- Beggin Css Assets -->
